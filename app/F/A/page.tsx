...
const assets = [
  { id: 1, name: "مشروع بناء مستشفى", remaining: 80 },
  { id: 2, name: " مشروع بناء مدرسة", remaining: 61 },
  { id: 3, name: " مشروع بناء خازوق", remaining: 25 },
  { id: 4, name: " مشروع بناء ", remaining: 5 },
];
  ...
  return (
    <main>
      <div className="flex items-center justify-center border-b dark:border-b-zinc-700">
        <h1 className="text-2xl text-center font-bold m-4">إدارة المشاريع</h1>
      </div>
