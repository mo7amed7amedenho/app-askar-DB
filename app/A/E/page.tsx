  ...
  const handlePrint = () => {
    ...
    printWindow.document.write(`
      <html>
        ...
        <body>
          <div class='container'>
            <h2>بيانات خصم العامل</h2>
            <p><strong>اسم العامل:</strong> ${formData.employeeName}</p>
            <p><strong>المبلغ الذي سيتم خصمه:</strong> ${formData.discountAmount} $</p>
            <p><strong>نسبة الخصم:</strong> ${formData.discountPercentage} %</p>
            <p><strong>تاريخ الخصم:</strong> ${formData.date}</p>
