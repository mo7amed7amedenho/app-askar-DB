...
const assets = [
  { id: 1, name: "أسمنت", remaining: 80 },
  { id: 2, name: "جبس", remaining: 61 },
  { id: 3, name: "حديد", remaining: 25 },
  { id: 4, name: "بلاستيك", remaining: 5 },
];
  ...
  return (
    <main>
      <div className="flex items-center justify-center border-b dark:border-b-zinc-700">
        <h1 className="text-2xl text-center font-bold m-4">إدارة المستهلكات</h1>
      </div>
      ...
      <div className="p-6 pt-10 grid gap-y-6 grid-cols-2 max-sm:grid-cols-1">
        ...
        <div className="w-full flex sm:px-8 flex-col">
          <h2 className="text-xl font-bold mb-4">حالة المستهلكات</h2>
