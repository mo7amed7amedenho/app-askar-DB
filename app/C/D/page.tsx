...
const assetData: Asset[] = [
  { id: 1, name: "عهدة مشروع A" },
  { id: 2, name: "عهدة مشروع B" },
];
  ...
  return (
    <div className="flex flex-col gap-y-4 p-4">
      <Card className="p-4 space-y-4">
        <h1 className="text-2xl font-bold">تقرير مصروفات العهدة</h1>
        <div className="flex gap-x-4">
          <Select placeholder="اختر العهدة">
            {assetData.map((asset) => (
          ...
          <Select placeholder="اختر نوع المصروف">
            ...
            <SelectItem value="صرف مرتب">صرف مرتب</SelectItem>
            <SelectItem value="صرف عادي">صرف عادي</SelectItem>
          </Select>
